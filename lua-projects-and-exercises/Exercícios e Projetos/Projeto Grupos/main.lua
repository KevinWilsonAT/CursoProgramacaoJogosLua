...
--Alterando a rotação dos itens do grupo de icones
...
-- Definindo a transparencia dos objetos do grupo
...
cloaks.y = 500
cloaks.rotation = -25
cloaks.isVisible = true

-- Adicionando / Removendo objetos do grupo

-- Exemplo: Adicionar um objeto ao grupo de iconsGroup

iconsGroup:insert(silho)

-- Exemplo: Remover um objeto do grupo iconsGroup
